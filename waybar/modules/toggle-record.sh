...
#AUDIO_SOURCE="$(pactl list short sources | awk '/\.monitor/ && /RUNNING/ { print $2; exit }')"
AUDIO_SOURCE="alsa_output.usb-GeneralPlus_USB_Audio_Device-00.analog-stereo.monitor"
